...
const multimedia = () => {
    ...
    return (
        <CourseLayout>
            <Head>
            <title>Multimedia Multiple Choice Question | Code Skipper</title>
        ...
        <link
          rel="canonical"
          href="https://CodeSkipper.in/mcq/multimedia-mca"
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:title"
          content="Multimedia Multiple Choice Question | Code Skipper"
        />
