...
const ml = () => {
    ...
    return (
        <CourseLayout>
            <Head>
            <title>Input Output Device Multiple Choice Question | Code Skipper</title>
        ...
        <link
          rel="canonical"
          href="https://CodeSkipper.in/mcq/io-device"
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:title"
          content="Input Output Device Multiple Choice Question | Code Skipper"
        />
