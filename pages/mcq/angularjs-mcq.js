...
const angularjsmcq = () => {
  ...
  <CourseLayout>
    <Head>
      <title>Top 50 AngularJS MCQ Questions with Answers | Code Skipper</title>
      <meta
        name="description"
        content="Comprehensive collection of AngularJS multiple choice questions (MCQs) with detailed answers. Test your AngularJS knowledge with these practice questions covering directives, scopes, filters, and more. Perfect for interview preparation and skill assessment."
      />
      ...
      <meta
        name="Keywords"
        content="AngularJS MCQs, AngularJS questions, AngularJS interview questions, AngularJS quiz, JavaScript framework MCQs, web development MCQs, SPA framework questions, AngularJS directives, AngularJS scopes, AngularJS filters, frontend development quiz"
      />
      ...
      <meta property="og:title" content="Top 50 AngularJS MCQ Questions with Answers | Code Skipper" />
      <meta
        property="og:description"
        content="Comprehensive collection of AngularJS multiple choice questions (MCQs) with detailed answers. Test your AngularJS knowledge with these practice questions covering directives, scopes, filters, and more."
      />
        ...
        <div className="divide-y divide-gray-300">
          ...
          {mcqs.map((mcq) => (
            <div key={mcq.id} className="space-y-6 py-8 text-base leading-7 text-gray-600">
              ...
              <details className="group open:duration-300 border rounded-lg overflow-hidden border-gray-300">
                <summary className="bg-blue-100 px-5 py-3 text-lg font-medium cursor-pointer flex justify-between items-center text-gray-900">
