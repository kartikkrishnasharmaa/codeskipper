...
const mongo = () => {
    ...
    return (
        <CourseLayout>
            <Head>
            <title>MongoDB Multiple Choice Question | Code Skipper</title>
        ...
        <link
          rel="canonical"
          href="https://CodeSkipper.in/mcq/mongodb-mcq"
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:title"
          content="MongoDB Multiple Choice Question | Code Skipper"
        />
