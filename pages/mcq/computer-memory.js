...
const cloud = () => {
    ...
    return (
        <CourseLayout>
            <Head>
            <title>Computer Memory Multiple Choice Question | Code Skipper</title>
        ...
        <link
          rel="canonical"
          href="https://CodeSkipper.in/mcq/computer-memory"
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:title"
          content="Computer Memory Multiple Choice Question | Code Skipper"
        />
