...
const cloud = () => {
    ...
    return (
        <CourseLayout>
            <Head>
            <title>C++ Language Multiple Choice Question | Code Skipper</title>
        ...
        <link
          rel="canonical"
          href="https://CodeSkipper.in/mcq/cpp-language"
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:title"
          content="C++ Language Multiple Choice Question | Code Skipper"
        />
