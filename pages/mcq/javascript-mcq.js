...
const ml = () => {
    ...
    return (
        <CourseLayout>
            <Head>
            <title>Javascript Multiple Choice Question | Code Skipper</title>
        ...
        <link
          rel="canonical"
          href="https://CodeSkipper.in/mcq/javascript-mcq"
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:title"
          content="Javascript Multiple Choice Question | Code Skipper"
        />
