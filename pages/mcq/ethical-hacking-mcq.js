...
const ethical = () => {
    ...
    return (
        <CourseLayout>
            <Head>
            <title>Ethical Hacking Multiple Choice Question | Code Skipper</title>
        ...
        <link
          rel="canonical"
          href="https://CodeSkipper.in/mcq/ethical-hacking-mcq"
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:title"
          content="Ethical Hacking Multiple Choice Question | Code Skipper"
        />
