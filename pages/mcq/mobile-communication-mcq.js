...
const mb = () => {
    ...
    return (
        <CourseLayout>
            <Head>
            <title>Mobile Communication Multiple Choice Question | Code Skipper</title>
        ...
        <link
          rel="canonical"
          href="https://CodeSkipper.in/mcq/mobile-communication-mcq"
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:title"
          content="Mobile Communication Multiple Choice Question | Code Skipper"
        />
