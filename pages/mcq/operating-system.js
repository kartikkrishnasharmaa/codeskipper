...
const mb = () => {
    ...
    return (
        <CourseLayout>
            <Head>
            <title>Operating System Multiple Choice Question | Code Skipper</title>
        ...
        <link
          rel="canonical"
          href="https://CodeSkipper.in/mcq/operating-system"
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:title"
          content=" Multiple Choice Question | Code Skipper"
        />
