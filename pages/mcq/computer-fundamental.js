...
const cloud = () => {
    ...
    return (
        <CourseLayout>
            <Head>
            <title>Computer Fundamental Multiple Choice Question | Code Skipper</title>
        ...
        <link
          rel="canonical"
          href="https://CodeSkipper.in/mcq/computer-fundamental"
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:title"
          content="Computer Fundamental Multiple Choice Question | Code Skipper"
        />
