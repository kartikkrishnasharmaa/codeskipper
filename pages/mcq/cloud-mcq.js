...
const cloud = () => {
    ...
    return (
        <CourseLayout>
            <Head>
            <title>Cloud Computing Multiple Choice Question | Code Skipper</title>
        ...
        <link
          rel="canonical"
          href="https://CodeSkipper.in/mcq/cloud-mcq"
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:title"
          content="Cloud Computing Multiple Choice Question | Code Skipper"
        />
