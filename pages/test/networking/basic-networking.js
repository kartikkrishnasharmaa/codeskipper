...
import RoadmapLayout from "@/components/layouts/TestLayout";
...
const IndexPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Basic Networking Quiz | Code Skipper</title>
        <meta
          name="description"
        ...
        <link
          rel="canonical"
          href="https://CodeSkipper.in/test/networking/basic-networking"
        />
        <meta
          property="og:image"
        ...
        <meta property="og:title" content="Privacy Policy | Code Skipper" />
        <meta
      ...
      <RoadmapLayout>
      <div className="box-border bg-white text-black h-full w-auto p-3 m-3 border-4 shadow-xl shadow-cyan-600 hover:shadow-indigo-700">
